...
const items = {
  ...
  incenses: ["Bloodthirst Incense", "Bulwark Incense", "Conjurer Incense", "Patience Incense", "Potency Incense", "Resilience Incense", "Restoration Incense", "Transmutation Incense", "Wellspring Incense"]
};
